...
function startQuiz() {
    ...
    quizHeaderImage.setAttribute("class", "quiz-header-img");
    quizHeaderImage.setAttribute("id", "quiz-question-img");
    quizHeaderImage.setAttribute("src", "assets/images/question-solid.svg");
    quizHeaderImage.setAttribute("alt", "quiz question header image");
    ...
    quizContent.appendChild(quizHeaderImage);
